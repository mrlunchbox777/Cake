public class Nuget
{
	public Nuget(ICakeContext context, CakeConfig cakeConfig){
		...
		string description = ("repo - "
									+ _config.ProjectInfo.RepositoryUrl ?? "Unknown"
									+ ", commit - "
		...
		this.ProjectUrl = string.IsNullOrWhiteSpace(_config.ProjectInfo.RepositoryUrl)
			? null
			: new Uri(_config.ProjectInfo.RepositoryUrl);
