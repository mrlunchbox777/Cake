public class ProjectInfo
{
	public ProjectInfo(ICakeContext context, bool stepUpADirectoryInConfigureSpace = false){
		...
		this.RepositoryUrl = (!string.IsNullOrWhiteSpace(this._context.EnvironmentVariable("REPO_URL"))
								? this._context.EnvironmentVariable("REPO_URL")
								: (!string.IsNullOrWhiteSpace(this._context.EnvironmentVariable("CI_REPOSITORY_URL"))
									...
									: null));
		this.WorkspaceRepository = this._context.EnvironmentVariable("CI_REPOSITORY_URL");
	}
